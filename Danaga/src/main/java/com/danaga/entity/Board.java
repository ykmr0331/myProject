...
public class Board extends BaseEntity {
	...
	public static Board toEntity(BoardDto dto, Member memberT, BoardGroup boardGroupT) {
		...
		return Board.builder().id(dto.getId()).title(dto.getTitle()).content(dto.getContent()).img1(dto.getImg1())
				.img2(dto.getImg2()).img3(dto.getImg3()).img4(dto.getImg4()).img5(dto.getImg5()).isLike(dto.getIsLike())
				.isAdmin(dto.getIsAdmin()).disLike(dto.getDisLike()).readCount(dto.getReadCount()).member(memberT)
				.boardGroup(boardGroupT).build();
	}
