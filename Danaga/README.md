...
- <span style="font-size: 1.5em;">다나와(컴퓨터, 가전제품) 쇼핑사이트 벤치마킹</span>
- <span style="font-size: 1.5em;">제품 종류를 옵션 기준 분류</span>
- <span style="font-size: 1.5em;">회원, 장바구니, 주문페이지 제작</span>
