...
<body>
		...
		<div class="category">
			<ul class="category_list">
				...
				<li><a href="product_form_brand_nike.jsp"><img
						...
						style="max-width: 110px; height: auto;"> </a> <br> <span
					style="font-size: 20px; color: red;">나이키</span></li>
			</ul>
		</div>
	...
	<ul class="product-list" style="text-align: center;">
		...
		List<Product> productList = productService.selectProductByBrand("나이키");
		...
		<li class="product"
			...
			<a href="product_form_action.jsp?p_no=<%=product.getP_no()%>"> <img
				src="images/<%=product.getP_image()%>"
