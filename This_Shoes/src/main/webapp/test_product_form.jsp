...
if (searchType.equals("all")) {
   productList = productService.productSelectAll();
}else if(searchType.equals("name")){
   searchName = request.getParameter("searchName");
   productList= productService.searchProductsByName(searchName);
}
/*  
...
List<Product> productList=productService.selectProductByBrand(p_brand)
...
<body>
   ...
   <div class="products">
      ...
      <div class="category">
         <ul class="category_list">
            <li><a href="test_product_form.jsp"><img
      ...
      <div class="search">
         <form action="test_product_form.jsp" method="GET">
            <input type="text" class="searchTerm" name="searchName" value="<%=searchName%>">
            <input type="hidden" name="searchType" value="name">
            <button type="submit" class="searchButton">
               <img src="css/image/search.png" alt="대체 텍스트"
   ...
   <ul class="product-list" style="text-align: center;">
      ...
      %>
      <li class="product"
         style="text-align: center; display: inline-table; width: 15%; padding: 5px;">
